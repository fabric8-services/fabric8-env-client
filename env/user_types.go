...
//
// API "env": Application User Types
//
// Command:
// $ goagen
...
// JSONAPI store for data of environment.
type environment struct {
	Attributes *environmentAttributes `form:"attributes,omitempty" json:"attributes,omitempty" xml:"attributes,omitempty"`
	// ID of environment
	ID    *uuid.UUID    `form:"id,omitempty" json:"id,omitempty" xml:"id,omitempty"`
...
// Validate validates the environment type instance.
func (ut *environment) Validate() (err error) {
	if ut.Type == nil {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`request`, "type"))
	}
...
// Publicize creates Environment from environment
func (ut *environment) Publicize() *Environment {
	var pub Environment
	if ut.Attributes != nil {
...
// JSONAPI store for data of environment.
type Environment struct {
	Attributes *EnvironmentAttributes `form:"attributes" json:"attributes" xml:"attributes"`
	// ID of environment
	ID    *uuid.UUID    `form:"id,omitempty" json:"id,omitempty" xml:"id,omitempty"`
	Links *GenericLinks `form:"links,omitempty" json:"links,omitempty" xml:"links,omitempty"`
	Type  string        `form:"type" json:"type" xml:"type"`
...
type environmentListMeta struct {
	TotalCount *int `form:"totalCount,omitempty" json:"totalCount,omitempty" xml:"totalCount,omitempty"`
}

// Validate validates the environmentListMeta type instance.
func (ut *environmentListMeta) Validate() (err error) {
...
// Publicize creates EnvironmentListMeta from environmentListMeta
func (ut *environmentListMeta) Publicize() *EnvironmentListMeta {
	var pub EnvironmentListMeta
	if ut.TotalCount != nil {
