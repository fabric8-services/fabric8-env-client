...
import (
	...
	"github.com/fabric8-services/fabric8-env-client/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "env-cli",
		Short: `CLI client for the env service`,
	}

	// Create client struct
	httpClient := newHTTPClient()
	c := env.New(goaclient.HTTPClientDoer(httpClient))
